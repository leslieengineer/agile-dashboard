...
## Ranh giới chưa có implementation

`MatterController` hiện chỉ có mock implementation. Adapter thật phải chịu trách nhiệm

- fabric storage
- commissioning
- CASE session
- invoke/read/write/subscribe
- timeout và Matter status mapping
- node discovery/reachability
- reconnect và subscription restoration
